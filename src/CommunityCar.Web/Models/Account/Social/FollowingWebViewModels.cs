...
public class UserFollowingWebVM
{
...
public class FollowingDashboardWebVM
{
    public Guid UserId { get; set; }
    public int FollowingCount { get; set; }
    public int FollowerCount { get; set; }
    public int MutualFollowingCount { get; set; }
    public List<UserFollowingWebVM> RecentFollowers { get; set; } = new();
    public List<UserFollowingWebVM> RecentFollowing { get; set; } = new();
    public List<UserSuggestionWebVM> SuggestedFollowing { get; set; } = new();
    public List<UserFollowingWebVM> MutualConnections { get; set; } = new();
}

public class FollowingListWebVM
{
    public Guid UserId { get; set; }
    public string ListType { get; set; } = string.Empty; // "following" or "followers"
    public List<UserFollowingWebVM> Users { get; set; } = new();
...
// Consolidated models from old Following folder
