...
public class RegisterVM
{
    ...
    [Display(Name = "FullName", ResourceType = typeof(AccountResource))]
    [StringLength(100)]
    public string? FullName { get; set; } = string.Empty;

    [Required(ErrorMessageResourceName = "FirstName", ErrorMessageResourceType = typeof(AccountResource))]
    [Display(Name = "FirstName", ResourceType = typeof(AccountResource))]
    [StringLength(50, MinimumLength = 1)]
    public string FirstName { get; set; } = string.Empty;

    [Required(ErrorMessageResourceName = "LastName", ErrorMessageResourceType = typeof(AccountResource))]
