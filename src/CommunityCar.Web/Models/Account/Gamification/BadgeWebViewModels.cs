...
public class BadgeCollectionWebVM
{
    public Guid UserId { get; set; }
    ...
    public List<UserBadgeWebVM> DisplayedBadgesList { get; set; } = new();
    public List<UserBadgeWebVM> AllBadges { get; set; } = new();
    public List<UserBadgeWebVM> RecentBadges { get; set; } = new();
}