...
namespace CommunityCar.Application.Common.Interfaces.Repositories.Dashboard.Management;

/// <summary>
/// Repository interface for UserManagementAction entity operations (Dashboard/Admin context)
/// </summary>
