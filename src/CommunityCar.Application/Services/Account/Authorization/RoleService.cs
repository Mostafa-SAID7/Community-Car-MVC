...
public class RoleService : IRoleService
{
    ...
    public async Task<IEnumerable<RoleDTO>> GetUserRoleDetailsAsync(Guid userId)
    {
    ...
    public async Task<IEnumerable<RoleDTO>> GetRoleHierarchyAsync()
    {
        var roles = await _roleRepository.GetRolesByPriorityAsync();
        return await MapRolesToDTOs(roles);
    }

    public async Task<RoleDTO?> GetHighestPriorityRoleAsync(Guid userId)
    {
    ...
    public async Task<RoleStatisticsDTO> GetRoleStatisticsAsync(string roleName)
    {
        ...
        return new RoleStatisticsDTO
        {
            ...
            RecentAssignments = new List<UserRoleSummaryDTO>() // This would need additional implementation
        };
    }

    public async Task<IEnumerable<UserRoleSummaryDTO>> GetUsersInRoleAsync(string roleName, int page = 1, int pageSize = 50)
    {
        ...
        return Enumerable.Empty<UserRoleSummaryDTO>();
    }
    ...
    public async Task<Dictionary<string, List<RoleDTO>>> GetRoleCategoriesAsync()
    {
        var roles = await _roleRepository.GetAllAsync();
    ...
    private async Task<IEnumerable<RoleDTO>> MapRolesToDTOs(IEnumerable<Role> roles)
    {
        var roleDTOs = new List<RoleDTO>();
